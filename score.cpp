...
void InitScore(void)
{
	...
	g_posScore = D3DXVECTOR3(800, 50, 0);		// 位置を初期化
	g_nScore = 0;								// 値を初期化
	...
	{
		// 頂点座標の設定(座標設定は必ず右回りで！！！)
		pVtx[0].pos.x = g_posScore.x + (50.0f * nCntScore) - 20.0f;
		pVtx[0].pos.y = g_posScore.y - 40.0f;
		pVtx[0].pos.z = 0.0f;

		pVtx[1].pos.x = g_posScore.x + (50.0f * nCntScore) + 20.0f;
		pVtx[1].pos.y = g_posScore.y - 40.0f;
		pVtx[1].pos.z = 0.0f;

		pVtx[2].pos.x = g_posScore.x + (50.0f * nCntScore) - 20.0f;
		pVtx[2].pos.y = g_posScore.y + 40.0f;
		pVtx[2].pos.z = 0.0f;

		pVtx[3].pos.x = g_posScore.x + (50.0f * nCntScore) + 20.0f;
		pVtx[3].pos.y = g_posScore.y + 40.0f;
		pVtx[3].pos.z = 0.0f;
