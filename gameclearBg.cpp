//================================================================================================================
//
// DirectXのゲームクリア時背景表示処理 [gameclearBg.cpp]
// Author : TENMA
//
//================================================================================================================
#include "main.h"
...
// グローバル変数
LPDIRECT3DTEXTURE9		g_pTextureGameclearBg = NULL;	// テクスチャへのポインタ
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffGameclearBg = NULL;	// 頂点バッファのポインタ
...
void InitGameclearBg(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
							  "data\\TEXTURE\\CHARACTER\\GameclearBg.png",
